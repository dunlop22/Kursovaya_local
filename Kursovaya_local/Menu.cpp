...
int Menu::Input_password()
{
	system("cls");
	string password;
	do
	{
		cout << "0) Для возврата в меню\n\nВведите пароль для доступа к режиму Администратор: ";
		cin >> password;
		if (password == "test\0")
		{
			system("cls");
...
{
	system("cls");
	cout << "1) Редактирование информации о кинотеатре\n2) Редактирование информации о фильмах в прокате\n3) Редактирование информации о промокодах\n4) Сменить кинотеатр";
	item_num = 4;
	

	//cout << "1) Заменить фильм\n2) Добавить фильм\n3) Удалить фильм\n4) Сменить кинотеатр";
}

void Menu::Edit_cinema()
{
	system("cls");
	cout << "Выберите пункт для редактирования информации\n\n1) Название\n2) Адрес\n3) ИНН\n4) РНМ\n0) Возврат в меню";
	item_num = 4;
